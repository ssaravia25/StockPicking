...
# Expanded Universe (From Stock_List.xlsx)
universe = list(dict.fromkeys([
    'MSFT', 'NVDA', 'AMZN', 'META', 'GOOGL', 'GOOG', 'BRK.B', 'AVGO', 'TSLA', 'LLY', 'JPM', 'V', 'UNH', 'MA', 'XOM', 'HD', 'PG', 'COST', 'JNJ', 'ABBV', 'BAC', 'CRM', 'ORCL', 'WMT', 'NFLX', 'CVX', 'KO', 'AMD', 'MRK', 'ADBE', 'PEP', 'CSCO', 'TMO', 'LIN', 'ACN', 'ABT', 'DIS', 'MCD', 'WFC', 'PM', 'GE', 'INTU', 'TXN', 'DHR', 'AMAT', 'CAT', 'RTX', 'IBM', 'BKNG', 'A', 'AAL', 'AAP', 'ABNB', 'AES', 'AFL', 'AIG', 'AIZ', 'AJG', 'AKAM', 'ALB', 'ALGN', 'ALK', 'ALL', 'ALLE', 'AMCR', 'AME', 'AMGN', 'AMP', 'AMT', 'ANET', 'ANSS', 'AON', 'AOS', 'APA', 'APD', 'APH', 'APTV', 'ARE', 'ATO', 'AVB', 'AVY', 'AWK', 'AXON', 'AXP', 'AYI', 'AZO', 'BA', 'BALL', 'BAX', 'BBWI', 'BBY', 'BDX', 'BEN', 'BF.B', 'BG', 'BIIB', 'BIO', 'BK', 'BLK', 'BMY', 'BR', 'BRO', 'BSX', 'BWA', 'BXP', 'C', 'CAG', 'CAH', 'CARR', 'CB', 'CBOE', 'CBRE', 'CCI', 'CCL', 'CDNS', 'CDW', 'CE', 'CEG', 'CF', 'CFG', 'CHD', 'CHRW', 'CHTR', 'CI', 'CINF', 'CL', 'CLX', 'CMA', 'CMCSA', 'CME', 'CMG', 'CMI', 'CMS', 'CNC', 'CNP', 'COF', 'COO', 'COP', 'COR', 'CPB', 'CPRT', 'CPT', 'CRL', 'CSGP', 'CSX', 'CTAS', 'CTRA', 'CTSH', 'CTVA', 'CVS', 'CZR', 'D', 'DAL', 'DD', 'DE', 'DFS', 'DG', 'DGX', 'DHI', 'DLR', 'DLTR', 'DOC', 'DOV', 'DOW', 'DPZ', 'DRI', 'DTE', 'DUK', 'DVA', 'DVN', 'DXCM', 'EA', 'EBAY', 'ECL', 'ED', 'EFX', 'EG', 'EIX', 'EL', 'ELV', 'EMN', 'EMR', 'ENPH', 'EOG', 'EPAM', 'EQIX', 'EQR', 'EQT', 'ES', 'ESS', 'ETN', 'ETR', 'ETSY', 'EVRG', 'EW', 'EXC', 'EXPD', 'EXPE', 'EXR', 'F', 'FANG', 'FAST', 'FCX', 'FDS', 'FDX', 'FE', 'FFIV', 'FI', 'FICO', 'FIS', 'FITB', 'FMC', 'FOX', 'FOXA', 'FRT', 'FSLR', 'FTNT', 'FTV', 'GD', 'GEHC', 'GEN', 'GEV', 'GILD', 'GIS', 'GL', 'GLW', 'GM', 'GNRC', 'GPC', 'GPN', 'GRMN', 'GS', 'GWRE', 'GWW', 'HAL', 'HAS', 'HBAN', 'HCA', 'HES', 'HIG', 'HII', 'HLT', 'HOLX', 'HON', 'HPE', 'HPQ', 'HRL', 'HSIC', 'HST', 'HSY', 'HUM', 'HWM', 'ICE', 'IDXX', 'IEX', 'IFF', 'ILMN', 'INCY', 'INTC', 'IP', 'IPG', 'IQV', 'IR', 'IRM', 'ISRG', 'IT', 'ITW', 'IVZ', 'JKHY', 'JCI', 'K', 'KDP', 'KEY', 'KEYS', 'KHC', 'KIM', 'KLAC', 'KMB', 'KMI', 'KMX', 'KVUE', 'L', 'LDOS', 'LEN', 'LH', 'LHX', 'LRCX', 'LULU', 'LUV', 'LVS', 'LW', 'LYB', 'LYV', 'MAA', 'MAR', 'MAS', 'MCO', 'MCK', 'MCHP', 'MDT', 'MET', 'MGM', 'MHK', 'MKC', 'MKTX', 'MLM', 'MMC', 'MMM', 'MNST', 'MO', 'MOH', 'MOS', 'MPC', 'MPWR', 'MRNA', 'MS', 'MSI', 'MTB', 'MTCH', 'MTD', 'MU', 'NDAQ', 'NDSN', 'NEE', 'NEM', 'NFE', 'NI', 'NKE', 'NRG', 'NSC', 'NTRS', 'NUE', 'NVR', 'NWS', 'NWSA', 'NXPI', 'O', 'ODFL', 'OKE', 'OMC', 'ON', 'OTIS', 'OXY', 'PANW', 'PARA', 'PAYC', 'PAYX', 'PCAR', 'PCG', 'PEG', 'PGR', 'PH', 'PHM', 'PKG', 'PLD', 'PLTR', 'PNC', 'PNR', 'PNW', 'PODD', 'POOL', 'PPG', 'PPL', 'PRU', 'PSA', 'PSX', 'PTC', 'PWR', 'PYPL', 'QCOM', 'QRVO', 'RCL', 'REG', 'REGN', 'RF', 'RHI', 'RJF', 'RL', 'RMD', 'ROK', 'ROL', 'ROP', 'ROST', 'RSG', 'RVTY', 'SBAC', 'SBUX', 'STX', 'SYK', 'SYF', 'SYY', 'T', 'TAP', 'TDG', 'TDY', 'TECH', 'TEL', 'TER', 'TFC', 'TFX', 'TGT', 'TJX', 'TKR', 'TMUS', 'TPR', 'TRGP', 'TRMB', 'TROW', 'TRV', 'TSCO', 'TT', 'TTWO', 'TYL', 'UAL', 'UDR', 'UHS', 'ULTA', 'UNP', 'UPS', 'URI', 'USB', 'VFC', 'VICI', 'VLO', 'VMC', 'VRSK', 'VRSN', 'VRTX', 'VTR', 'VZ', 'WAB', 'WAT', 'WBA', 'WDC', 'WEC', 'WELL', 'WHR', 'WM', 'WMB', 'WST', 'WTW', 'WY', 'WYNN', 'XEL', 'XYL', 'YUM', 'ZBH', 'ZBRA', 'ZTS', 'ADP', 'ADSK', 'AEP', 'APP', 'ASML', 'AZN', 'BKR', 'DASH', 'DDOG', 'MDLZ', 'MELI', 'MRVL', 'ORLY', 'SNPS', 'TEAM', 'WDAY', 'ZS', 'LRN', 'TMHC', 'MHO', 'GRBK', 'GHC', 'DJCO', 'BBW', 'GIII', 'NGVC', 'IBEX', 'WK', 'CHX', 'GTLS', 'LFST', 'CRDO', 'BE', 'FAB', 'IONQ', 'ASTH', 'SANM', 'CVLT', 'RDW', 'APLD', 'FULT', 'SPOK', 'PLAB', 'OFLX', 'MTH', 'CCS', 'LAD', 'AN', 'GPI', 'ASB', 'BOH', 'CBU', 'VLY', 'PNFP', 'WBS', 'CATY', 'HWC', 'IBOC'
]))
